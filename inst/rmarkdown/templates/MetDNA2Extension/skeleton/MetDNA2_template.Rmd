...
# max_rounds <- max(unique_rounds)
# 
# id_result_known <- id_result %>% dplyr::filter(cpd_type %in% c('known_unknown', 'unknown_unknown'))
# 
# stat_num <- pbapply::pblapply(unique_rounds, function(i){
#   num_annotation <- id_result_known %>% 
#     # dplyr::filter(level == i) %>% 
...
<center>**Figure 5.** Curated unknown metabolites in recursive annotation </center> 
<br>
